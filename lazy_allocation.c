...
int main(void){
  ...
  //~~~~~~~~~~~~~~~~~~~~~ SMALL CHUNK ~~~~~~~~~~~~~~~~~~~~~
    ...
    if(pread(fd,
             ...
             page_small * sizeof small_chunk_before)!= sizeof small_chunk_before)
    {
        perror("pread");
        return 1;
    }
    ...
    *probe_small = 'S';
    ...
    if(pread(fd,
             ...
             page_small * sizeof small_chunk_after)!= sizeof small_chunk_after)
    {
        perror("pread");
        return 1;
    }
